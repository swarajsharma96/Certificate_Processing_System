...
$query = "SELECT s.student_name, a.student_id, a.apply_date, a.apply_id FROM student s RIGHT JOIN apply a ON s.student_id = a.student_id RIGHT JOIN administrator ad ON ad.apply_id = a.apply_id WHERE ad.account_status=0";
$statement = null;
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right menu">
                    ...
                    <li><a href="../Login/edit.php?q=<?php echo $_SESSION['user_name']?>" class="logout">ACCOUNT-Edit</a></li>
                </ul>
            </div>
        </div>
    </nav>
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                while ($dataRow = $statement->fetch()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>$apply_date</td>
                                        <td>
                                            <a href="accounts_form.php?id=$studentID&aid=$applyID" class="btn btn-success">NEXT</a>
                                        </td>
                                    </tr>
Tag;
                                }
