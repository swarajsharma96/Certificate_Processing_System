        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right menu">
                    <li class="active"><a href="#">Clearance & info<span class="sr-only">(current)</span></a></li>
        ...
        <div class="row">
            ...
            <div class="row">
                        ...
                        <div class="row fieldRows">
                            <table class="table table-hover table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-center error">On-Progress... </p>
                                    </td>
                                </tr>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <form action="registerFormController.php?aid=<?php echo $applyID; ?>" method="post">
                        <div class="form-div new-form-div">
                            <div class="row">
                                    ...
                                    <div class="checkbox">
                                        <label class="propertyValue">
                                            <div class="col-md-12 text-capitalize">
                                                ...
                                                <span class="h5 approval-text"><i>Let him/her Issue certificate & Transcript </i></span>
                                            </div>
                                ...
                                <div class="col-md-offset-3 col-sm-offset-3 col-xs-offset-3 col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <button type="submit" name="Register-Final_Stage" class="btn btn-success">Inform Student</button>
                                </div>
                            </div>
                        </div>
                    </form>
