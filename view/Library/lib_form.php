        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <div class="brand navbar-brand">
                    ...
                    <a href="#" class="h3">Library</a>
                </div>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right menu">
                    <li class="active"><a href="#">Library Clearance<span class="sr-only">(current)</span></a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class= "col-md-offset-2 col-sm-offset-1 col-md-8 col-sm-10 col-xs-12">
                ...
                <div class="form-div">
                    <p class="lead text-uppercase text-center head-text">Library Info</p>
                    <div class="">
                        <form action="lib_controller.php" method="post">
                            <div class="row">
                                <div class="col-md-offset-2 col-sm-offset-2 col-xs-offset-1 col-md-11 col-sm-11 col-xs-11">
                                    <div class="finance">
                                        <label class="propertyValue">
                                            ...
                                            Does all are cleared ? &nbsp; &nbsp;&nbsp; &nbsp;
                                        </label>

                                        <div class="radio-inline">
                                            <label class="propertyValue">
                                                <input type="radio" name="clearance" id="radio-yes" value="1">
                                                YES
                                            </label>
                                        </div>
                                        ...
                                        <div class="radio-inline">
                                            <label class="propertyValue">
                                                <input type="radio" name="clearance" id="radio-no" value="0" checked>
                                                NO
                                            </label>
                                        </div>
                                    </div>
                    ...
                    <div class="">
                        <form action="../Remarks/remarksController.php?aid=<?php echo $applyID; ?>" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-offset-3 col-sm-offset-3 col-xs-offset-3 col-md-6 col-sm-6 col-xs-6">
                                    <input type="text" name="path" value="Library/lib_dashboard.php" hidden>
                                    <button type="submit" name="REJECT" value="Library" class="btn btn-danger">Reject</button>
                                </div>
